...
public class TodoItemDto {
	...
	public static class WriteReq {
		...
		public TodoItem toEntity() {
			return TodoItem.builder().content(this.content).done(this.done).build();
		}
	}
	...
	public static class ModifyContentReq {
		...
		public TodoItem toEntity() {
			return TodoItem.builder().content(this.content).build();
		}
	}
	...
	public static class ModifyDoneReq {
		...
		public TodoItem toEntity() {
			return TodoItem.builder().done(this.done).build();
		}
	}
