...
public class TestMemberService {
	...
	public void 이미_가입한_이메일로_회원가입() {
		// given
		SignUpRequest dto = new SignUpRequest(Email.build("lteawoo@naver.com"), "이태우", Password.build("12345"));
	...
	public void 가입하지_않은_이메일로_회원가입() {
		...
		SignUpRequest dto = new SignUpRequest(email, "이태우", Password.build("12345"));
